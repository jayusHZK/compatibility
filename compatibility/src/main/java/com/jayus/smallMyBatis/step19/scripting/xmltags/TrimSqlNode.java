...
public class TrimSqlNode implements SqlNode {
    ...
    public TrimSqlNode(Configuration configuration, SqlNode contents, String prefix, String prefixesToOverride
        ...
        this(configuration, contents, prefix, parserOverrides(prefixesToOverride), suffix, parserOverrides(suffixesToOverride));
    }
    ...
    private static List<String> parserOverrides(String overrides) {
        if (overrides != null) {
