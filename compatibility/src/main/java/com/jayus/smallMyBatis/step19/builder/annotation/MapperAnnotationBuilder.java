package com.jayus.smallMyBatis.step19.builder.annotation;

import com.jayus.smallMyBatis.step19.annotations.Delete;
import com.jayus.smallMyBatis.step19.annotations.Insert;
import com.jayus.smallMyBatis.step19.annotations.Select;
import com.jayus.smallMyBatis.step19.annotations.Update;
import com.jayus.smallMyBatis.step19.binding.MapperMethod;
...
public class MapperAnnotationBuilder {
    ...
    private void parseStatement(Method method) {
        ...
        if (sqlSource != null) {
            ...
            // 调用助手类
            assistant.addMappedStatement(mappedStatementId, sqlSource, sqlCommandType, parameterTypeClass, resultMapId, getRetureType(method)
                    , false, false, keyGenerator, keyProperty, languageDriver);
        }
    }
     ...
     */
    private Class<?> getRetureType(Method method) {
    ...
    private String parseResultMap(Method method) {
        ...
        Class<?> retureType = getRetureType(method);
        assistant.addResultMap(resultMapId, retureType, new ArrayList<>());
        return resultMapId;
    }
