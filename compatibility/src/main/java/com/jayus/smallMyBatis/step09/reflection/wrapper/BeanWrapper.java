...
import com.jayus.smallMyBatis.step09.reflection.SystemMetaObject;
...
public class BeanWrapper extends BaseWrapper {
    ...
    public Object get(PropertyTokenizer prop) {
        // 如果有 index (有中括号) 说明是集合 那就要解析集合 调用 BaseWrapper.resolveCollection 和 getCollectionValue
    ...
    /**
     * 从属性分词器中解析到的属性 从 object 中得到该属性值
     * @param prop
     * @param object
     * @return
     */
    ...
    /**
     * 从属性分词器中解析到的属性 设置值到object 的对应属性中
     * @param prop
     * @param object
     * @param value
     */
