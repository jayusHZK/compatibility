...
public class MetaClass {
    ...
    public String findProperty(String name,boolean useCanelCaseMapping){
        if (useCanelCaseMapping){
            name = name.replace("_","");
        }
    ...
    private Type getGenericGetterType(String propertyName){
        try {
            ...
            if (invoker instanceof MethodInvolker){
                Field _method = MethodInvolker.class.getDeclaredField("method");
    ...
    public Invoker getSetInvokere(String name){
