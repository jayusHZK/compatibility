...
public class ParameterExpression extends HashMap<String, String> {
    ...
    private int skipWS(String exprssion, int p) {
        for (int i = p; i < exprssion.length(); i++) {
            if (exprssion.charAt(i) > 0x20) {
                return i;
            }
        }
        return exprssion.length();
    }
