...
import com.jayus.smallMyBatis.step12.datasource.unpooled.UnpooledDataSource;
...
public class PooledDataSource implements DataSource {
    ...
    protected int poolPingConnectionsNoUsedFor = 0;
    ...
    protected boolean pingConnection(PooledConnection conn) {
        ...
        if (result) {
            if (poolPingEnabled) {
                if (poolPingConnectionsNoUsedFor >= 0 && conn.getTimeElapsedSinceLastUse() > poolPingConnectionsNoUsedFor) {
                    try {
    ...
    public int getPoolPingConnectionsNoUsedFor() {
        return poolPingConnectionsNoUsedFor;
    }

    public void setPoolPingConnectionsNoUsedFor(int poolPingConnectionsNoUsedFor) {
        this.poolPingConnectionsNoUsedFor = poolPingConnectionsNoUsedFor;
    }
