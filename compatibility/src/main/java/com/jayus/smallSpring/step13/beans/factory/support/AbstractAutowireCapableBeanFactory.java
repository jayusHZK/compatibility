...
import com.jayus.smallSpring.step13.beans.factory.DisposableBean;
import com.jayus.smallSpring.step13.beans.factory.InitializingBean;
import com.jayus.smallSpring.step13.beans.factory.config.*;
...
public abstract class AbstractAutowireCapableBeanFactory extends AbstractBeanFactory implements AutowireCapableBeanFactory {
    ...
    protected void registDisposableBeanIfNecessary(String beanName, Object bean, BeanDefinition beanDefinition) {
    ...
    protected void applyProperValues(String beanName, Object bean, BeanDefinition beanDefinition) {
        try {
