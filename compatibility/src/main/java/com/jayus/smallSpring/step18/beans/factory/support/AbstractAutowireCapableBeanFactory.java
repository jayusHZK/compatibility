...
import com.jayus.smallSpring.step18.beans.PropertyValue;
import com.jayus.smallSpring.step18.beans.PropertyValues;
import com.jayus.smallSpring.step18.beans.factory.*;
import com.jayus.smallSpring.step18.beans.factory.config.*;
...
public abstract class AbstractAutowireCapableBeanFactory extends AbstractBeanFactory implements AutowireCapableBeanFactory {
    ...
    protected Object doCreateBean(String beanName, BeanDefinition beanDefinition, Object[] args) {
        ...
        try {
            ...
            // 在设置 Bean 之前，允许 BeanPostProcessor 修改属性值
    ...
    private Object initializeBean(String beanName, Object bean, BeanDefinition beanDefinition) {
        if (bean instanceof Aware) {
            ...
            if (bean instanceof BeanClassLoaderAware){
                ((BeanClassLoaderAware) bean).setBeanClassLoader(getBeanClassLoad());
            }
