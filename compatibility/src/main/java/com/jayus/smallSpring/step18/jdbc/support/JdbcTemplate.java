...
import com.jayus.smallSpring.step18.jdbc.UncategorizedSqlException;
import com.jayus.smallSpring.step18.jdbc.core.*;
import com.jayus.smallSpring.step18.jdbc.datasource.DataSourceUtils;
...
public class JdbcTemplate extends JdbcAccessor implements JdbcOperations {
    ...
    private <T> T execute(PreparedStatementCreator psc, PreparedStatementCallback<T> action
        ...
        try {
            ...
            con = null;
            throw new UncategorizedSqlException("PreparedStatementCallback",sql,e);
        } finally {
            if (closeResources){
